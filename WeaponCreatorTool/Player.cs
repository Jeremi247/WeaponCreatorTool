    ...
    class Player : Entity
    {
        ...
        public void Shoot()
        {
            ...
            if (timeToNextShot <= 0)
            {
                ...
                {
                    Bullet bullet = new Bullet(bulletTexture, spawnPosition, bulletSize, weapon.BulletColor, bulletTarget, weapon.BulletSpeed, weapon.BulletsSpread, weapon.FadingTime);
