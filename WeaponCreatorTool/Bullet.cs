...
{   //With use of this class it is possible to create bullets of various sizes, velocitys and looks
    class Bullet : Entity
    {
        ...
        public Bullet(Texture2D texture, Vector2 position, Vector2 scale, Color color, Vector2 targetPosition, float speed, float spread, double _fadingTime) : base(texture, position, scale, color)
        {
        ...
        {
            var amount = (255d / (double)fadingTime) * (double)gameTime.ElapsedGameTime.TotalSeconds;
